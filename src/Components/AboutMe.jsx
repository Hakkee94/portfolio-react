        ...
        <div className="about" id='about'>
            ...
            <div>
                ...
                <h2 className="last-subtitle">
                    ...
                    Начал индивидуальное обучение с репетитором 3 года назад, сверстал много лендингов, постоянно практикуюсь и открываю для себя новые технологии в разработке.
                    Из последнего - активно постигаю Redux, Typescript
                </h2>
            </div>
